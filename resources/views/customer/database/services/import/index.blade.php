    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="{{ route('customer.database.service.index') }}" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back</a>
                <a href="{{ route('customer.database.service.export-template') }}" class="btn btn-success"><i class="fa fa-download"></i> Download template</a>
            </div>
