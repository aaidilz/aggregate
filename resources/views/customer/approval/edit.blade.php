                            ...
                            <div id="parts-wrapper">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="part_number[]"
                                        value="{{ old('part_number.0', $approval->parts[0]->part_number ?? '') }}" placeholder="Enter Part ID">
                                ...
                                @for ($i = 1; $i < count($approval->parts); $i++)
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="part_number[]"
                                            value="{{ old('part_number.'.$i, $approval->parts[$i]->part_number) }}" placeholder="Enter Part ID">
                                        <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="datetime-local" name="request_date" id="request_date" class="form-control"
                                onpaste="handlePaste(event)" required value="{{ old('request_date', $approval->request_date) }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="datetime-local" name="create_zulu_date" id="create_zulu_date" class="form-control"
                                onpaste="handlePaste(event)" value="{{ old('create_zulu_date', $approval->create_zulu_date) }}">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="status_part" id="status_part" class="form-control">
                                ...
                                <option value="Ready" {{ old('status_part', $approval->status->status_part) == 'Ready' ? 'selected' : '' }}>Ready</option>
                                <option value="Pending Part CWH" {{ old('status_part', $approval->status->status_part) == 'Pending Part CWH' ? 'selected' : '' }}>Pending Part CWH</option>
                                <option value="SOH" {{ old('status_part', $approval->status->status_part) == 'SOH' ? 'selected' : '' }}>SOH</option>
                                <option value="Pending Part Kota Terusan" {{ old('status_part', $approval->status->status_part) == 'Pending Part Kota Terusan' ? 'selected' : '' }}>Pending Part Kota Terusan</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="email_request" id="email_request" class="form-control">
                                ...
                                <option value="Non Area Remote" {{ old('email_request', $approval->status->email_request) == 'Non Area Remote' ? 'selected' : '' }}>Non Area Remote</option>
                                <option value="Area Remote" {{ old('email_request', $approval->status->email_request) == 'Area Remote' ? 'selected' : '' }}>Area Remote</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="status_email_request" id="status_email_request" class="form-control">
                                ...
                                <option value="Passed" {{ old('status_email_request', $approval->status->status_email_request) == 'Passed' ? 'selected' : '' }}>Passed</option>
                                <option value="Need Approval" {{ old('status_email_request', $approval->status->status_email_request) == 'Need Approval' ? 'selected' : '' }}>Need Approval</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="SN_part_good" id="SN_part_good" class="form-control" value="{{ old('SN_part_good', $approval->status->SN_part_good) }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="SN_part_bad">SN Part Bad</label>
                                    <input type="text" name="SN_part_bad" id="SN_part_bad" class="form-control" value="{{ old('SN_part_bad', $approval->status->SN_part_bad) }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select name="status_part_used" id="status_part_used" class="form-control">
                                        ...
                                        <option value="Defective" {{ old('status_part_used', $approval->status->status_part_used) == 'Defective' ? 'selected' : '' }}>Defective</option>
                                        <option value="Good" {{ old('status_part_used', $approval->status->status_part_used) == 'Good' ? 'selected' : '' }}>Good</option>
                                        <option value="DOA" {{ old('status_part_used', $approval->status->status_part_used) == 'DOA' ? 'selected' : '' }}>DOA</option>
                                        <option value="Consume" {{ old('status_part_used', $approval->status->status_part_used) == 'Consume' ? 'selected' : '' }}>Consume</option>
                                    </select>
                                </div>
                            </div>
                        </div>
